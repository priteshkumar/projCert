...
stage('test-deploy'){
    node('master'){
       ...
       // ansiblePlaybook become: true, becomeUser: null, colorized: true, disableHostKeyChecking: true, playbook: '${WORK//SPACE}/ansible/jenkins-test-terminate.yml', sudoUser: null
